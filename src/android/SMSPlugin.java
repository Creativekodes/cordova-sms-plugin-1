...
extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray inputs, CallbackContext callbackContext) throws JSONException {
        ...
        if (ACTION_SET_OPTIONS.equals(action)) {
            ...
            String addressList = inputs.optString(0);
    ...
    private PluginResult sendSMS(String phoneNumber, String message, final CallbackContext callbackContext) {
        ...
        if (this.cordova.getActivity().getPackageManager().hasSystemFeature("android.hardware.telephony")) {
			...
			//SmsManager manager = SmsManager.getSmsManagerForSubscriptionId(0);
			...
			final BroadcastReceiver broadcastReceiver = new BroadcastReceiver() {
				...
				public void onReceive(Context context, Intent intent) {
					...
					case SmsManager.RESULT_ERROR_GENERIC_FAILURE:
						callbackContext.sendPluginResult(new PluginResult(PluginResult.Status.ERROR, "GENERIC FAILURE" ));
					case SmsManager.RESULT_ERROR_NO_SERVICE:
						callbackContext.sendPluginResult(new PluginResult(PluginResult.Status.ERROR, "NO SERVICE"));
					case SmsManager.RESULT_ERROR_NULL_PDU:
						callbackContext.sendPluginResult(new PluginResult(PluginResult.Status.ERROR, "NULL PDU"));
					case SmsManager.RESULT_ERROR_RADIO_OFF:
						callbackContext.sendPluginResult(new PluginResult(PluginResult.Status.ERROR, "RADIO OFF"));
						anyError = true;
						break;
					}
